...
export const REVIEW_SELECTED_SNIPPET = 'review_selected_snippet'
export const SNIPPETIFY_USER_CARD_URL = 'https://snippetify.com/users/embed_card'
export const SNIPPETIFY_NEW_SNIPPET_URL = 'https://snippetify.com/snippets/new_embed'
